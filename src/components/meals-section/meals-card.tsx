...
export default function MealCard({ title, image }: prpos) {
  return (
    <div className=" w-96 h-96 group rounded-2xl overflow-hidden cursor-pointer shadow-md hover:shadow-xl transition">
      {/* Image */}
      <img
        src={image}
        alt={title}
      ...
      <div className=" p-3 bg-gray-300 text-black flex flex-col justify-start items-start gap-2">
        ...
        <button className="flex items-center gap-2 mt-2 text-sm font-semibold text-orange-600 group-hover:gap-3 transition-all">
          Read More
