...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex h-14 w-12 items-center justify-center border-b-2 text-2xl font-medium transition-all",
        isHighlighted ? "border-[#FF4A11] text-[#FF4A11]" : "border-muted-foreground text-muted-foreground",
        isActive && "z-10",
        className
      )}
      {...props}
