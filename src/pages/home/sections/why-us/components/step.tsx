...
export default function Step({ isEnd, num }: StepProps) {
  return (
    <div
      className={cn(
        "step relative min-size-14 size-14 flex items-center justify-center text-xs bg-[#FF4100] text-[#F3F3F4] border border-[#24242424] rounded-full font-bold shrink-0",
        !isEnd &&
